<!-- REPLACE ALL THE [SimonR1ley] TEXT WITH YOUR GITHUB PROFILE NAME & THE [termoneexample] WITH THE NAME OF YOUR GITHUB PROJECT -->
...
<p align="center">
  ...
  <a href="https://github.com/SimonR1ley/termoneexample">
  ...
  <p align="center">
   ...
   <a href="path/to/demonstration/video">View Demo</a>
    ·
    <a href="https://github.com/SimonR1ley/termoneexample/issues">Report Bug</a>
    ·
    <a href="https://github.com/SimonR1ley/termoneexample/issues">Request Feature</a>
</p>
<!-- TABLE OF CONTENTS -->
...
1. GitHub Desktop </br>
Enter `https://github.com/SimonR1ley/termoneexample.git` into the URL field and press the `Clone` button.

2. Clone Repository </br>
Run the following in the command-line to clone the project:
   ```sh
   git clone https://github.com/SimonR1ley/termoneexample.git
   ```
...
See the [open issues](https://github.com/SimonR1ley/termoneexample/issues) for a list of proposed features (and known issues).
